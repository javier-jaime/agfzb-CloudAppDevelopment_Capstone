...
def analyze_review_sentiments(text):
    api_key = "WBKuv6PYIDtxEw6zvQoAtvKbY3_HS0vG9AC8UpaeRsAl"
    url = "https://api.us-south.natural-language-understanding.watson.cloud.ibm.com/instances/5b81a5fb-ae55-40a8-afbb-7dd5dee47ec2"
    texttoanalyze= text
    version = '2020-08-01'
